...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cosinnus_event_event', 'created_by_id')


    def backwards(self, orm):
        # Adding field 'Event.created_by'
        # get any valid user id, will be overwritten by 0004 migration anyway
        valid_user_id = orm['auth.User'].objects.all()[0].id
        db.add_column(u'cosinnus_event_event', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=valid_user_id, related_name=u'events', on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)
