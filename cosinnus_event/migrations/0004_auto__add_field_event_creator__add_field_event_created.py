...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cosinnus_event_event', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cosinnus_event_event_set', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Event.created'
        db.add_column(u'cosinnus_event_event', 'created',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'cosinnus_event_event', 'creator_id')

        # Deleting field 'Event.created'
        db.delete_column(u'cosinnus_event_event', 'created')
