...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'event_event', 'public')

        # Deleting field 'Event.image'
        db.delete_column(u'event_event', 'image')

        # Deleting field 'Event.page'
        db.delete_column(u'event_event', 'page_id')

        # Deleting field 'Event.url'
        db.delete_column(u'event_event', 'url')
