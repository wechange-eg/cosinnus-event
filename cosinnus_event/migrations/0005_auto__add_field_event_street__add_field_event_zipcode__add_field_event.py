...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.street'
        db.add_column(u'event_event', 'street',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.zipcode'
        db.add_column(u'event_event', 'zipcode',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.city'
        db.add_column(u'event_event', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.street'
        db.delete_column(u'event_event', 'street')

        # Deleting field 'Event.zipcode'
        db.delete_column(u'event_event', 'zipcode')

        # Deleting field 'Event.city'
        db.delete_column(u'event_event', 'city')
