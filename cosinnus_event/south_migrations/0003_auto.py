...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field attached_objects on 'Event'
        m2m_table_name = db.shorten_name(u'cosinnus_event_event_attached_objects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'cosinnus_event.event'], null=False)),
            ('attachedobject', models.ForeignKey(orm[u'cosinnus.attachedobject'], null=False))
        ))
        db.create_unique(m2m_table_name, ['event_id', 'attachedobject_id'])


    def backwards(self, orm):
        # Removing M2M table for field attached_objects on 'Event'
        db.delete_table(db.shorten_name(u'cosinnus_event_event_attached_objects'))
