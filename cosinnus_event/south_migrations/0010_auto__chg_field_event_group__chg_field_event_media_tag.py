...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cosinnus_event_event', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cosinnus.CosinnusGroup']))

        # Changing field 'Event.media_tag'
        db.alter_column(u'cosinnus_event_event', 'media_tag_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cosinnus.TagObject'], unique=True, null=True, on_delete=models.SET_NULL))
